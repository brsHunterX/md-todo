...
import 'package:md_todo/modules/auth/widgets/hyperlink.dart';
...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  Widget _buildEmailSignUpButton() {
    return Container(
      ...
      child: ElevatedButton(
        ...
        onPressed: () => Navigator.of(context).pushNamed(AuthRoutes.AUTH_SIGN_IN),
      ),
    );
  }
  ...
  Widget _buildSignUpLink() {
    return Hyperlink(
      ...
      linkText: 'Sign up',
      onTap: () => Navigator.of(context).pushNamed(AuthRoutes.AUTH_SIGN_UP)
    );
  }
